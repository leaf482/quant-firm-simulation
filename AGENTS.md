...
- The architecture and task order are recorded in `outputs/phase-1-plan.md`. Tasks 1 (bootstrap), 2 (minimal domain contracts), and 3 (CSV replay) are approved; subsequent implementation tasks require user approval.
