...
- The architecture and task order are recorded in `outputs/phase-1-plan.md`. Tasks 1–8 (through the in-memory portfolio) are approved; subsequent implementation tasks require user approval.
